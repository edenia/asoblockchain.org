export const plans = [
  ...
  },
  {
    id: 2,
    cost: 600,
    title: 'Empresa de 16 a 30 empleados',
    items: [
      'Se brinda acceso a eventos de la organización, voz y voto en la toma de decisiones.',
      'Acceso a información sobre oportunidades en el área de BLOCKCHAIN en Costa Rica.',
      'Asesoría para aprovechar oportunidades en el área BLOCKCHAIN.',
  ...
  },
  {
    id: 4,
    cost: 150,
    title: 'Asociado con Derecho de Voz y Voto',
    items: [
      'Se brinda acceso a eventos de la organización a precio de descuento, voz y voto en la toma de decisiones.',
      'Acceso a información sobre oportunidades en el área de BLOCKCHAIN en Costa Rica.',
      'Asesoría para aprovechar oportunidades en el área BLOCKCHAIN.',
      'Networking.',
  ...
  },
  {
    id: 5,
    cost: 50,
    title: 'Afiliado sin Derecho a Voto',
    items: [
